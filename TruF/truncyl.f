...
C 
        ...
        open(2,file='surface_nodes.txt',status='old')
        !open(204,file='nodes4.txt',status='old')
        !open(203,file='nodes3.txt',status='old')
        !open(202,file='nodes2.txt',status='old')
...
C 
       ...
       write(402,202) m,dble(r2),dimag(re)
        end do
